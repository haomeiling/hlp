 ...
 **/
@Slf4j
public class ResInterceptor extends AbstractPhaseInterceptor<SoapMessage> {
    /**
     ...
     */
    public ResInterceptor(String phase) {
        super(phase);
    }
    ...
    public void handleMessage(SoapMessage message) throws Fault {
        ...
        log.info("HIS InterFace[{}] Res --> {}", method.getName(), result.get(0));
    }
}

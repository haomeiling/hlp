...
/**
 * Description: 时间工具
 * Package: com.bxd.sip.reservation.utils
 *
 * @author Leeves
...
public class DateUtils {
     ...
     * @return 日期集合
     */
    public static List<Date> getAllBetweenDates(Date start, Date end) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sdf.format(DateUtils.getFrontDay(new Date(), 7)));
    }

    public static String yyyyMMddToStr(Integer yyyyMMdd) {
        String res = "";
        if (yyyyMMdd > 0) {
            String str = yyyyMMdd.toString();
            if (str.length() >= 8) {
                StringBuffer stringBuffer = new StringBuffer(str);
                stringBuffer.insert(4, "-").insert(7, "-");
                res = stringBuffer.toString() + " 00:00:00";
            }
        }
        return res;
    }

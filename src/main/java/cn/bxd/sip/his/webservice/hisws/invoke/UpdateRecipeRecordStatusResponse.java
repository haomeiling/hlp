...
@XmlType(name = "", propOrder = {
		"updateRecipeRecordStatusResult"
})
@XmlRootElement(name = "updateRecipeRecordStatusResponse")
public class UpdateRecipeRecordStatusResponse {

	protected String updateRecipeRecordStatusResult;

	public String getUpdateRecipeRecordStatusResult() {
		return updateRecipeRecordStatusResult;
	}

	public void setUpdateRecipeRecordStatusResult(String updateRecipeRecordStatusResult) {
		this.updateRecipeRecordStatusResult = updateRecipeRecordStatusResult;
	}

 ...
 * 
 */
@WebServiceClient(name = "Reg", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://172.16.11.40:1800/Reg.asmx?WSDL")
public class Reg
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://172.16.11.40:1800/Reg.asmx?WSDL");

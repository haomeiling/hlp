...
@XmlType(name = "", propOrder = {
		"updateInHosRecordStatusResult"
})
@XmlRootElement(name = "updateInHosRecordStatusResponse")
public class UpdateInHosRecordStatusResponse {

	protected String updateInHosRecordStatusResult;

	public String getUpdateInHosRecordStatusResult() {
		return updateInHosRecordStatusResult;
	}

	public void setUpdateInHosRecordStatusResult(String updateInHosRecordStatusResult) {
		this.updateInHosRecordStatusResult = updateInHosRecordStatusResult;
	}
